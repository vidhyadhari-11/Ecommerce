...
const PlaceOrder = () => {
  ...
  return (
    <div className='max-w-screen-xl mx-auto flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
...
{/*  -----------------left side------------------- */}
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='text-xl sm:text-2xl my-3'>
          ...
          <input type="email" placeholder='Email' className='border border-gray-300 rounded py-1.5 px-3.5 w-full mt-3' />
